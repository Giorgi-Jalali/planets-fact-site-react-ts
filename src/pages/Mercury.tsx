...
export default function Mercury() {
  ...
  let planetColor = miniData[0].color;
...
const Photo = styled.div<{ internalPage: string }>`
  background-image: url(${(props) => props.internalPage === "structure" ? `${mercuryInternal}` : `${mercury}`});
...
const PlanetGeology = styled.div<{
  ...
  background-image: url(${(props) => props.internalPage === "geology" ? `${mercuryGeology}` : "none"});
  background-repeat: no-repeat;
